...
<html>
	<head>
	    ...
	    <?= $this->Html->meta('icon') ?>
	    <?= $this->Html->css(['bootstrap.min.css','animate.css','graph.css','style.css','icon-font.min.css','font-awesome.css']) ?>



		<!-- <script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script> -->
		<!--animate-->
		<?= $this->Html->script(['jquery-3.2.1.min.js','bootstrap.min.js','jquery.nicescroll.js','scripts.js','Chart.js','wow.min.js','classie.js','uisearch.js','jquery.flot.min.js','jquery-1.10.2.min.js']) ?>

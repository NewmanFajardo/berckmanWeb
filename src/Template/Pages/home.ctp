...
<div class="row">
    <div class="columns large-12">
        <div class="ctp-warning alert text-center">
            <p>hola como estas Please be aware that this page will not be shown if you turn off debug mode unless you replace src/Template/Pages/home.ctp with your own version.</p>
        </div>
